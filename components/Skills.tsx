...
const skillCategories = [
  ...
  },
  {
    ...
    techs: [
      ...
      { name: 'GitHub', svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="#24292E"/><path d="M50 14C30 14 14 30 14 50c0 16 10 29 24 34 2 0.3 2.5-0.8 2.5-1.8v-6c-10 2-12.5-5-12.5-5-1.7-4.3-4.2-5.4-4.2-5.4-3.4-2.3 0.3-2.3 0.3-2.3 3.7 0.3 5.7 3.8 5.7 3.8 3.3 5.7 8.7 4 10.8 3 0.3-2.4 1.3-4 2.3-4.9-8.2-0.9-16.9-4.1-16.9-18.3 0-4 1.4-7.3 3.8-9.9-0.4-1-1.6-4.7 0.3-9.7 0 0 3.1-1 10 3.8 3-0.8 6-1.2 9-1.2s6 0.4 9 1.2c7-4.8 10-3.8 10-3.8 2 5 0.7 8.7 0.3 9.7 2.4 2.6 3.8 5.9 3.8 9.9 0 14.2-8.7 17.3-17 18.2 1.3 1.2 2.5 3.5 2.5 7v10.4c0 1 0.5 2.1 2.5 1.8C76 79 86 66 86 50 86 30 70 14 50 14z" fill="white"/></svg>` },
      { name: 'REST API', svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="8" fill="#1E293B"/><rect x="10" y="35" width="36" height="12" rx="3" fill="#38BDF8" opacity="0.9"/><rect x="54" y="35" width="36" height="12" rx="3" fill="#F472B6" opacity="0.9"/><rect x="10" y="53" width="36" height="12" rx="3" fill="#4ADE80" opacity="0.9"/><rect x="54" y="53" width="36" height="12" rx="3" fill="#FB923C" opacity="0.9"/><text x="28" y="44" text-anchor="middle" font-family="monospace" font-size="8" font-weight="bold" fill="white">GET</text><text x="72" y="44" text-anchor="middle" font-family="monospace" font-size="8" font-weight="bold" fill="white">POST</text><text x="28" y="62" text-anchor="middle" font-family="monospace" font-size="7" font-weight="bold" fill="white">PATCH</text><text x="72" y="62" text-anchor="middle" font-family="monospace" font-size="8" font-weight="bold" fill="white">DEL</text></svg>` },
      ...
      { name: 'cPanel/VPS', svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="8" fill="#1A1A2E"/><rect x="15" y="20" width="70" height="18" rx="4" fill="#16213E" stroke="#FF6B35" stroke-width="1.5"/><circle cx="27" cy="29" r="3" fill="#4ADE80"/><circle cx="37" cy="29" r="3" fill="#FB923C"/><circle cx="47" cy="29" r="3" fill="#F43F5E"/><rect x="15" y="44" width="70" height="18" rx="4" fill="#16213E" stroke="#475569" stroke-width="1.5"/><circle cx="27" cy="53" r="3" fill="#4ADE80"/><rect x="15" y="68" width="70" height="12" rx="4" fill="#16213E" stroke="#475569" stroke-width="1.5"/></svg>` },
    ],
  },
  {
    title: 'SAP S/4HANA',
    ...
    color: '#0070F2',
    techs: [
      { name: 'ABAP', svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="8" fill="#0070F2"/><text x="50" y="44" text-anchor="middle" font-family="monospace" font-weight="900" font-size="16" fill="white">ABAP</text><text x="50" y="66" text-anchor="middle" font-family="monospace" font-size="10" fill="rgba(255,255,255,0.7)">S/4HANA</text></svg>` },
      { name: 'SAP Fiori', svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="8" fill="#0070F2"/><circle cx="50" cy="42" r="18" fill="none" stroke="white" stroke-width="5"/><circle cx="50" cy="42" r="8" fill="white"/><rect x="30" y="66" width="40" height="5" rx="2.5" fill="rgba(255,255,255,0.6)"/><rect x="38" y="75" width="24" height="5" rx="2.5" fill="rgba(255,255,255,0.4)"/></svg>` },
      { name: 'CDS View', svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="8" fill="#0A1628"/><ellipse cx="50" cy="38" rx="32" ry="12" fill="none" stroke="#0070F2" stroke-width="3"/><ellipse cx="50" cy="50" rx="32" ry="12" fill="none" stroke="#0070F2" stroke-width="3" opacity="0.6"/><ellipse cx="50" cy="62" rx="32" ry="12" fill="none" stroke="#0070F2" stroke-width="3" opacity="0.3"/><line x1="18" y1="38" x2="18" y2="50" stroke="#0070F2" stroke-width="3"/><line x1="82" y1="38" x2="82" y2="50" stroke="#0070F2" stroke-width="3"/></svg>` },
      { name: 'OData', svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="8" fill="#0A1628"/><path d="M20 50 Q35 25 50 50 Q65 75 80 50" fill="none" stroke="#0070F2" stroke-width="4" stroke-linecap="round"/><circle cx="20" cy="50" r="5" fill="#0070F2"/><circle cx="50" cy="50" r="5" fill="#0070F2"/><circle cx="80" cy="50" r="5" fill="#0070F2"/><text x="50" y="80" text-anchor="middle" font-family="monospace" font-size="11" fill="rgba(0,112,242,0.8)">OData</text></svg>` },
      { name: 'BTP', svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="8" fill="#0070F2"/><path d="M50 18 L75 35 L75 65 L50 82 L25 65 L25 35 Z" fill="none" stroke="white" stroke-width="4"/><path d="M50 30 L65 40 L65 60 L50 70 L35 60 L35 40 Z" fill="white" opacity="0.2"/><text x="50" y="56" text-anchor="middle" font-family="monospace" font-weight="bold" font-size="11" fill="white">BTP</text></svg>` },
      { name: 'Int. Suite', svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="8" fill="#0A1628"/><circle cx="28" cy="50" r="12" fill="#0070F2"/><circle cx="72" cy="50" r="12" fill="#0070F2"/><circle cx="50" cy="28" r="12" fill="#0070F2" opacity="0.7"/><circle cx="50" cy="72" r="12" fill="#0070F2" opacity="0.7"/><line x1="38" y1="44" x2="40" y2="38" stroke="#38BDF8" stroke-width="2.5"/><line x1="62" y1="44" x2="60" y2="38" stroke="#38BDF8" stroke-width="2.5"/><line x1="38" y1="56" x2="40" y2="62" stroke="#38BDF8" stroke-width="2.5"/><line x1="62" y1="56" x2="60" y2="62" stroke="#38BDF8" stroke-width="2.5"/><circle cx="50" cy="50" r="6" fill="#38BDF8"/></svg>` },
    ],
  },
  {
    title: 'Design UI/UX',
    ...
    techs: [
      ...
      { name: 'Adobe XD', svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="12" fill="#FF61F6"/><rect width="100" height="100" rx="12" fill="#2E001E" opacity="0.85"/><path d="M22 72l14-22-13-20h10l7 13 7-13h10L44 50l14 22H48L40 58l-8 14z" fill="#FF61F6"/></svg>` },
    ],
  },
]
  ...
  return (
    <section id="skills" ref={ref} className="relative py-32 overflow-hidden grid-bg"
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12">
        ...
        {/* ══════════════════════════════════════
            SKILL CARDS — logos par catégorie
        ══════════════════════════════════════ */}
              ...
              <div className="flex flex-wrap gap-3">
                {cat.techs.map((tech, i) => (
                  <motion.div key={tech.name}
                    ...
                    transition={{
                      delay: 0.5 + catIdx * 0.1 + i * 0.05,
                      type: 'spring', stiffness: 300, damping: 22,
                    }}
                    whileHover={{ scale: 1.15, y: -4 }}
                    className="group flex flex-col items-center gap-1.5 cursor-default">

                    <div className="w-11 h-11 flex items-center justify-center rounded-xl p-1.5
